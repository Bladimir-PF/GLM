...
summary(wald_improvement, test = Chisqtest())
```
...
print("Yhat in logits for specific values of predictors") 
Main2Logits = prediction(model=Model2Main, type="link",
                         at=list(gpa3=-1:1,parD=0:1,priv=0:1))
summary(Main2Logits)
print("Yhat in probability for specific values of predictors") 
Main2Probs = prediction(model=Model2Main, type="response", 
                        at=list(gpa3=-1:1,parD=0:1,priv=0:1))
summary(Main2Probs)