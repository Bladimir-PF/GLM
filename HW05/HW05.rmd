...
summary(glht(model=m2, df=992, linfct=rbind(
  ...
  "Q39" = c(0,1/2,0,0,0,1/2,0,0),
  "Q41" = c(0,0,0,0,0,0,0,0),
  "Q43" = c(0,0,0,0,0,0,1,0),
  "Q45" = c(-1,0,0,1,-1,0,0,1))),test=adjusted("none"))
```

Q41. {report} For participants trained in pancakes, enter the estimate for the difference in the effect of experience between their crepe vs. pancake outcomes	
Q42. {report} For participants trained in pancakes, enter the standard error for the difference in the effect of experience between their crepe vs. pancake outcomes	
Q43. {report} For participants trained in crepes when making pancakes, enter the estimate for the effect of experience	
Q44. {report} For participants trained in crepes when making pancakes, enter the standard error for the effect of experience	
Q45. {report} For participants trained in crepes when making crepes, enter the estimate for the effect of experience	
Q46. {report} For participants trained in crepes when making crepes, enter the standard error for the effect of experience	
Q47. {report} For participants trained in crepes, enter the estimate for the difference in the effect of experience between their pancake vs. crepe outcomes	
Q48. {report} For participants trained in crepes, enter the standard error for the difference in the effect of experience between their pancake vs. crepe outcomes	
Q49. {report} When outcome type matches training type, enter the estimate for the difference in the effect of experience between pancake vs. crepe outcomes	
Q50. {report} When outcome type matches training type, enter the standard error for the difference in the effect of experience between pancake vs. crepe outcomes	
Q51. {report} When outcome type does NOT match training type, enter the estimate for the difference in the effect of experience between pancake vs. crepe outcomes	
Q52. {report} When outcome type does NOT match training type, enter the standard error for the difference in the effect of experience between pancake vs. crepe outcomes